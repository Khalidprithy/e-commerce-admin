...
function MyContextProvider(props) {
  ...
  const login = async (phone, password) => {
    ...
    const response = await fetch('https://e-commerce-admin-fv58.onrender.com/api/auth/login', {
      method: 'POST',
      headers: {
  ...
  const SignUp = async (data, e) => {
    ...
    const response = await fetch('https://e-commerce-admin-fv58.onrender.com/api/auth/signup', {
      method: 'POST', // or 'PUT'
      headers: {
        'Content-Type': 'application/json',
      },
